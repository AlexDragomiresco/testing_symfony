...
class ClientsController extends Controller
{
    ...
    **/
    public function showIndex()
    {
        ...
        $logger->info('A user has opened the guests page');
        $logger->error('The user cannot see the guest page');
    ...
    **/
    public function showNew(Request $request)
    {
        ...
        if( $form->isSubmitted() )
        {
            ...
            $em->persist($client); //prepare data for query

            $em->flush(); //create and execute query
